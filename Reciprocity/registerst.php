<?php
	...
	if(mysqli_connect_error()){
		...
		if(array_key_exists("name", $_POST) AND array_key_exists("email", $_POST) AND array_key_exists("password", $_POST) AND array_key_exists("cpassword", $_POST) AND array_key_exists("phone_number", $_POST) AND array_key_exists("enrollment_number", $_POST) AND array_key_exists("gender", $_POST)){
			//user has eneter everything or blank page is submitted
			if($_POST['email']=="" OR $_POST['password']=="" OR $_POST['cpassword']=="" OR $_POST['name']=="" OR $_POST['phone_number']=="" OR $_POST['enrollment_number']==""OR $_POST['gender']==""){
				...
				if(mysqli_num_rows($result)>0){
					...
					$query="INSERT INTO users (name,email,password,phone_number,enrollment_number,gender) VALUES ('".$_POST['name']."','".$_POST['email']."','".$_POST['password']."','".$_POST['phone_number']."','".$_POST['enrollment_number']."','".$_POST['gender']."')";//*********SQL PROTECTION REQUIRED*******
...
<form method="post">
	<div class="reg-box">
		...
		<div class="textbox">
			<input type="number" placeholder="Phone Number"	name="phone_number" autocomplete="off">  
		</div>

		<div class="textbox">
			<input type="text" placeholder="Enrollment Number" name="enrollment_number" autocomplete="off">  
		</div>
