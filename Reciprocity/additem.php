<?php
  ...
  if(mysqli_connect_error()){
    ...
    if(array_key_exists("title", $_POST) AND array_key_exists("description", $_POST) AND array_key_exists("course", $_POST) AND array_key_exists("branch", $_POST) AND array_key_exists("sem", $_POST) AND array_key_exists("phone", $_POST)){
      ...
      $query="INSERT INTO books (userid,title,description,course,branch,sem,image,phone) VALUES('$userid','$title','$description','$course','$branch','$sem','$image','$phone')";
...
<body>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <a href="logoutClicked.php">
            <button type="button" class="btn btn-dang">LOGOUT</button>
          </a>  
        </ul>
  ...
  <section id="add" class="wow fadeInUp">
  <form id="additemform" method="POST" enctype="multipart/form-data" action="additem.php">
  <?php 
    if ($msg) {
