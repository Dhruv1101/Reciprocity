...
<form method="post">
	...
	<div class="textbox">
		<label>
			Email<br>
			<input type="Email" pattern=".+@ppsu.ac.in" placeholder="abc@bookshare.com" name="email" autocomplete="off">  
		</label>
	</div>
    ...
    <div class="login-popup">
      <div class="form-popup" id="popupForm">
        <form class="form-container">
		  <h2>Select Accroding To Your Profession</h2>
		  
		  <a href="register.php">
		  <button type="button" class="btn" onclick="register.php">StaFf</button>
	      </a>
          
	      <a href="registerst.php">
		  <button type="button" class="btn" onclick="registerst.php">Student</button>
	      </a>
