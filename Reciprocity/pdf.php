    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#se">Select Paper</a></li>
...
<table width="80%" border="0" align="center">
    <tr align="center"><th colspan="4"><h3 id="ourproducts">PAPERS</h3></th></tr>
    <tr border="0"><b>
    <td align="center">Paper Name</td>
    <td align="center">Year</td>
    <td align="center">View</td></b>
  ...
  <div class="container">
    <div class="row">
      ...
      if(isset($_GET['Go']))
      {
        ...
        $sem=$_GET['sem'];
        $exam=$_GET['exam'];
        $sql="SELECT `name`,`year`,`pdf` FROM papers WHERE branch='$branch' AND sem='$sem' AND exam='$exam'";
      }
          ...
          while($row = mysqli_fetch_array($result)) {
            ...
            <td align="Center"><a href="papers/<?php echo $row['pdf'] ?>" >View</a></td>
            <!--<td align="center"><form action="view.php"><input type="submit" value="Download" name="dl"></input></form></td>-->
            </tr>
            <?php
          }?>
          </table>
      ...
      <center><br><br><br>
      <button  type="submit" name="btn-upload">Upload Paper</button></center>
      </form>    
